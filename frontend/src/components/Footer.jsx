...
const socials = [
  {
    label: "Instagram",
    href: "https://instagram.com/Cboyistore",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  {
    label: "TikTok",
    href: "https://tiktok.com/@Cboyistore",
    icon: (
  ...
  {
    label: "Email",
    href: "mailto:wisede63@gmail.com",
    icon: (
      <svg
        viewBox="0 0 24 24"
        fill="none"
  ...
  return (
    <footer className="bg-ink pb-24 pt-10 text-cream/50 sm:pb-10">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-6 px-4 text-center sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:text-left lg:px-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-3">
          {socials.map((s) => (
            <a
              ...
              aria-label={s.label}
              className="focus-ring flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-cream transition-colors hover:bg-signal hover:text-white"
            >
              {s.icon}
            </a>
          ))}
        ...
        <p className="text-xs">© {new Date().getFullYear()} Cboyistore. All rights reserved.</p>
      </div>
    </footer>
  );
}
